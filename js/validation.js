...
language["header"]	= "Se produjeron los siguientes errores:"
language["start"]	= "->";
language["field"]	= " Campo ";
language["require"]	= " requerido";
language["min"]		= " y debe contener al menos ";
language["max"]		= " y no debe contener mas de ";
language["minmax"]	= " y no mas de ";
language["chars"]	= " caracteres";
language["num"]		= " y debe contener un numero";
language["email"]	= " debe contener un correo valido";
// -----------------------------------------------------------------------------
